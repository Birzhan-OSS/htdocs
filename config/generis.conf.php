...
define('GENERIS_SESSION_NAME','tao_LLXGJGfm');

# paths
define('ROOT_PATH','C:\\xampp\\htdocs\\');
define('ROOT_URL','http://localhost:89/');

# language
define('DEFAULT_LANG','ru-RU');
define('DEFAULT_ANONYMOUS_INTERFACE_LANG','ru-RU');
...
define('FILES_PATH','C:\\xampp\\htdocs\\data\\');
